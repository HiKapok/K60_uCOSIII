...
//    SetIntPri_Kinetis(15,0);
//
//    SYST_CSR = ((1<<SysTick_CSR_ENABLE_SHIFT)&SysTick_CSR_ENABLE_MASK)|((1<<SysTick_CSR_CLKSOURCE_SHIFT)&SysTick_CSR_CLKSOURCE_MASK);                                                       /* Enable timer.                                          */
//
//                                                            /* Enable timer interrupt.                                */
//    EnableInt_Kinetis(15);
    CPU_INT32U  prio;
