...
;NVIC_INT_CTRL   EQU     0xE000E200                              ; Interrupt control state register.
;NVIC_INT_EN     EQU     0xE000E100                              ; Interrupt enable register.
;NVIC_SYSPRI14   EQU     0xE000E40E                              ; System priority register (priority 14).
;NVIC_PENDSV_PRI EQU           0xFF                              ; PendSV priority value (lowest).
;NVIC_PENDSVSET  EQU     0x00004000                              ; Value to trigger PendSV exception.
...
OSStartHighRdy
    ...
    ;MOV32   R0, NVIC_INT_EN                                     ; Set the PendSV exception enable
    ...
    MOV32   R0, OSRunning                                       ; OSRunning = 1
    EOR     R1, R1, R1
    ORR     R1, R1, #1
    STRB    R1, [R0]
